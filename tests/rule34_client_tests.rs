...
async fn search_sends_tags_limit_and_credentials() {
    ...
    Mock::given(method("GET"))
        ...
        .and(query_param("tags", "1girl artist:foo bar"))
...
async fn continuation_uses_resuming_client_and_preserves_query() {
    ...
    Mock::given(method("GET"))
        ...
        .and(query_param("user_id", "origin_user"))
    ...
    Mock::given(method("GET"))
        ...
        .and(query_param("user_id", "resume_user"))
...
async fn trait_post_preserves_error_context() {
    ...
    for error in [inherent_error, trait_error] {
        ...
        assert_eq!(context.provider, booru_rs::error::Provider::Rule34);
